...
The next tutorial will cover the implementation and customiazion of the detail window.

Proceed to [Shopware Backend Compents - Detail](/developers-guide/backend-components/detail/).